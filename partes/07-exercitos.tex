...
Cada exército em Vanguarda 44 carrega a identidade da nação que representa --- não apenas em uniformes e armamento, mas em como luta. Esta parte explica como montar seu Pelotão e como as Doutrinas Nacionais tornam cada exército uma experiência tática diferente à mesa.
...
Se você chegou até aqui vindo da Parte IV lembrando que ``Vanguarda 44 não usa pontos'', isso continua verdadeiro dentro de cada esquadrão --- o que muda aqui é a escala: estamos decidindo quantas unidades cabem no seu Pelotão, não quanto vale cada soldado dentro delas.

\begin{nota}
A Qualidade de Tropa (Inexperiente, Regular ou Veterana) de cada unidade não é uma característica fixa do exército ou da doutrina --- ela é definida pelo cenário escolhido (Parte VIII). As mesmas miniaturas podem ser designadas como Veteranas para um lado e Regulares para o outro, retratando o contexto histórico específico daquele cenário (por exemplo, tropas alemãs de elite podem ser Veteranas contra tropas americanas Regulares recém-desembarcadas no Dia D).
\end{nota}
