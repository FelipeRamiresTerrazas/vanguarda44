...
\textbf{Proteção (Escudo de Estado-Maior)}: ao ser declarado como alvo de tiro, se houver qualquer outra unidade amiga a até 5cm do QG e mais exposta a quem atira, o defensor pode exigir que o inimigo mire nessa unidade mais próxima em vez do QG. Exceção: um Sniper usando Tiro Selecionado (\ref{sec:equipe-sniper}) pode escolher o Oficial diretamente, ignorando esta proteção.
...
\textbf{Baixa do Operador de Rádio}: a Rede de Comando cai imediatamente (veja \ref{sec:quebrando-linha}).

\textbf{Baixa do Oficial}: o Pelotão perde imediatamente os PC daquele posto. Se houver um Sargento de Pelotão (\ref{sec:sargento-pelotao}) em campo, ele assume a ativação de Unidades de Suporte normalmente (com sua penalidade padrão). Caso contrário, as unidades de Suporte sem sargento próprio só podem atirar de forma Autônoma (\ref{sec:cabo-especialista}) até a chegada de outro Oficial.
