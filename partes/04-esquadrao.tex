...
Ninho de Metralhadora: Equipe de LMG completa (Atirador + Municiador) + Sargento SMG + 3 Fuzileiros & 10 / 6 & Poder de fogo de longo alcance e supressão \\
\bottomrule
\end{tabular}
\end{center}

\begin{nota}
A Metralhadora Leve só pode ser incluída na lista como equipe completa de 2 homens (Atirador + Municiador, 5 slots), não é possível montar um esquadrão com uma LMG ``solo'' desde a criação da lista. Ela só opera sozinha em campo se o Municiador for perdido como baixa durante a partida, seguindo a Regra Geral de Perda do Assistente (\ref{sec:perda-assistente}).
\end{nota}
...
\begin{nota}
A Thompson M1928, apelidada de ``Tommy Gun'', já era famosa antes da guerra pelo uso no crime organizado americano, mas foi nas mãos da infantaria e dos paraquedistas que ganhou fama militar, valorizada pelo poder de parada em combate próximo, apesar do peso e do alcance curto.
\end{nota}
...
Role 1D6. Resultado 4, 5 ou 6: mina neutralizada. Resultado 2 ou 3: falha técnica, tente de novo no próximo turno. Resultado 1 (Falha Crítica): o Engenheiro é removido como baixa e a mina explode.
