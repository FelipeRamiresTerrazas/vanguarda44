...
\textbf{Ativação para Disparo}: o QG raramente precisa se ativar para atirar, já que normalmente gasta seus PC ativando outras unidades (veja 20.1--20.3). Se decidir atirar, cada auxiliar armado (pistola, 1 dado) participa normalmente, seguindo a Sequência de Disparo padrão (Parte III).
