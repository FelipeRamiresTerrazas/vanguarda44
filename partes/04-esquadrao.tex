...
Todo Esquadrão de Infantaria começa com esta formação equilibrada de 10 homens:

\begin{center}
\begin{tabular}{p{3.6cm}p{4.6cm}p{4.2cm}}
\toprule
Função & Armamento & Benefício \\
\midrule
1 Sargento (Líder) & Submetralhadora (SMG) & Gera 1 Ponto de Comando \\
1 Equipe de Metralhadora Leve & 1 Atirador (LMG) + 1 Municiador (Rifle) & Fogo de supressão \\
7 Fuzileiros & Rifle & Volume de tiro padrão \\
\bottomrule
\end{tabular}
\end{center}
...
Stress causado & 1 Pin & 2 Pins (regra de Supressão) \\
\bottomrule
\end{tabular}
\end{center}
...
No início da ativação do Esquadrão em que o Médico está integrado (antes de mover ou atirar), a unidade remove automaticamente 1 Marcador de Stress. Este efeito é automático e não gasta PC, mas o Médico deve estar vivo.
...
Arma de Uso Único. Alcance de arremesso de 10cm ou contato de base. Contra Edifícios/Bunkers: se acertar (4+), causa 2D6 Acertos Automáticos em quem estiver dentro, ignora a Cobertura Pesada do prédio, e gera 3 Marcadores de Stress automáticos.
